...
Команда разработки:
- :white_check_mark: [themasterid (в роли Python-разработчика Тимлид - разработчик 1)](https://github.com/nemnogospaal)
- :white_check_mark: [EvgenyAlexandrov (в роли Python-разработчика - разработчик 2)](https://github.com/absurdnik1)
- :white_check_mark: [madpenguinw роль (в роли Python-разработчика - разработчик 3)](https://github.com/Tikhonov-prog)
